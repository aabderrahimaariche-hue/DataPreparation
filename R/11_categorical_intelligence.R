...
#'
#' @param data A data frame containing categorical column
...
#'
#' @export
encode_categorical_flags <- function(data, categorical_col, identifier_col = NULL, 
...
#'
#' @export
count_categories <- function(data, identifier_col = NULL, categorical_col, delimiter = "\\\\|") {
...
#'
#' @export
extract_primary_category <- function(data, identifier_col, categorical_col, delimiter = "\\\\|") {
...
#'
#' @param data A data frame with delimited categorical column
#' @param categorical_col Column name with delimited categories
...
#'
#' @export
compute_category_statistics <- function(data, categorical_col, value_col, delimiter = "\\\\|") {
...
#'
#' @param data A data frame with identifier, categories, and values
...
#'
#' @export
compute_category_preferences <- function(data, identifier_col, categorical_col, 
                                               value_col, delimiter = "\\\\|") {
...
#'
#' @export
compute_category_diversity <- function(data, categorical_col, delimiter = "\\\\|") {
...
#'
#' @param data A data frame with delimited categories
#' @param identifier_col Column name containing entity identifiers
#' @param categorical_col Column name with delimited categories
#' @param delimiter Pattern to split categories (default: "\\\\|")
#'
...
#'
#' @export
compute_category_combinations <- function(data, identifier_col, categorical_col, delimiter = "\\\\|") {
